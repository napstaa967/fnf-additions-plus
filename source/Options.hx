...
class SkipIntroOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.introskip = !FlxG.save.data.introskip;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.introskip ? "Skip Intro" : "Dont Skip Intro";
	}
}

class DarkModeOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.darkmode ? "Dark Mode" : "Light Mode";
	}
}
...
class FullscreenOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.fullscreen ? "Fullscreen" : "Windowed";
	}
}
...
class ResetSettings extends Option
{
	...
	public override function press():Bool
	{
		...
		FlxG.save.data.darkmode = null;
		FlxG.save.data.introskip = null;
