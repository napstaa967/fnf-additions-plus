...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Appearance", [
			...
			new DarkModeOption("Toggle Dark Mode."),
			new FullscreenOption("Toggle fullscreen.")
		]),
		...
		new OptionCategory("Misc", [
			...
			new SkipIntroOption("Toggle FNF Start intro.")
		]),
	...
	override function create()
	{
		...
		if (FlxG.save.data.darkmode)
		{
			var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image("menuDarkDesat"));
			menuBG.color = 0xFFea71fd;
			menuBG.setGraphicSize(Std.int(menuBG.width * 1.1));
			menuBG.updateHitbox();
			menuBG.screenCenter();
